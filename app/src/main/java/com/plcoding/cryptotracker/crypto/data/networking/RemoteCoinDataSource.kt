...
import com.plcoding.cryptotracker.crypto.data.networking.dto.CoinsResponceDto
...
class RemoteCoinDataSource(
    ...
    override suspend fun getCoints(): Result<List<Coin>, NetworkError> {
        return safeCall<CoinsResponceDto> {
            httpClient.get(
