...
//                    color = style.unSelectedColor,
                    ...
                    strokeWidth = if (selectedDataPointIndex == index) {
                        style.helperLineThicknessPx * 3f
                    } else {
...
//                    color = style.unSelectedColor,
        ...
        drawPoints = visibleDataPointsIndices.map {
            ...
            // DataPoint pos on visible vertical helperLine
        ...
        drawPoints.forEachIndexed { index, point ->
            if (isShowingDataPoints) {
                ...
                drawCircle(
                    color = style.selectedColor,
                    radius = if (selectedDataPointIndex == index) 5f else 10f,
                    center = circleOffset
                )
            }
        }
...
private fun LineChartPreview() {
    CryptoTrackerTheme {
        ...
        val style = ChartStyle(
            ...
            helperLineThicknessPx = 1f, // Stroke.HairlineWidth
